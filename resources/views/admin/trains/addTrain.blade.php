          ...
          <nav>
              <div class="nav-wrapper light-blue">
                <div class="col s12">
                  ...
                  <a href="{{URL::to('/dashboard/viewTrains')}}" class="breadcrumb">Trains</a>
                  <a href="#!" class="breadcrumb">Add Train</a>
                </div>
              </div>
            </nav>
          </div>
            ...
            <div class="col s12">
                <div class="card white">
                    <div class="card-content">
                        ...
                        <h5 class="center">Add A Train</h5>
                        <div class="divider"></div><br>
                            <div class="en-container">
                                    <form class="" action="{{URL::to('/insertTrain')}}" method="post" autocomplete="off">
                                        {!! csrf_field() !!}
                                        ...
                                        <ul class="collapsible" data-collapsible="accordion">
                                                ...
                                                <li>
                                                <div class="collapsible-header"><h6>Trip Information</h6></div>
                                                <div class="collapsible-body">
                                                    
                                                            <div class="row">
                                                                    <div class="input-field col s12">
                                                                        <input id="rute_from" name="rute_from" type="text" class="validate stasiun" required>
                                                                        <label for="rute_from">Origin</label>
                                                                    </div>
                                                                    <div class="input-field col s12">
                                                                        <input id="rute_to" name="rute_to" type="text" class="validate stasiun" required>
