...
<form class="" action="{{URL::to('/updatePlaneRoute')}}" method="post" autocomplete="off">
    {!! csrf_field() !!}
    ...
    <div class="row">
        <div class="row">
                <div class="input-field col s12">
                    <input id="rute_from" name="rute_from" type="text" class="validate bandara" required value="{{$route->rute_from}}">
                    <label for="rute_from">Depart From</label>
                </div>
                <div class="input-field col s12">
                    <input id="rute_to" name="rute_to" type="text" class="validate bandara" required value="{{$route->rute_to}}">
